  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        {/* Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 bg-gradient-to-r from-orange-500 to-red-500 text-white flex-shrink-0">
        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 cart-drawer-content">
              {items.map((item) => (
                <div key={item.id} className="bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center gap-3">
            ...
            {/* Order Summary */}
            <div className="p-4 sm:p-6 space-y-4 bg-gradient-to-r from-orange-50 to-red-50 flex-shrink-0 pb-20 md:pb-6 cart-drawer-summary">
              ...
              <Button
                asChild
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white py-4 text-base font-bold min-h-[56px] cart-drawer-button rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
                onClick={() => setIsCartOpen(false)}
                style={{ WebkitTapHighlightColor: 'transparent', outline: 'none', border: 'none' }}
              >
